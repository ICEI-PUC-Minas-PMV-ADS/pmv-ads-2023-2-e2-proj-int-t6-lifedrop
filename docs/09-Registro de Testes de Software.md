...
CT - 05 - Acessar histórico de doações 
<ul>
  <li><strong>Objetivo do teste</strong>:Verificar se o usuário consegue gerenciar e agendar seu agendamento.</li>
...
<ul>
  ...
  <li><strong>Resultado</strong>: O gerenciamento foi realizado com sucesso e salvo no banco de dados local.</li>
  </ul>
...
<ul>
  <li><strong>Objetivo do teste</strong>:Verificar se o administrador consegue ter acesso ao painel administrativo.</li>
